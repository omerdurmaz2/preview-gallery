 ...
 *
 * Split out (PG12-3) from [ZoomableRenderViewTest], which now owns that class name for the dp-space
 * sizing/hit-test suite: wheel pan/zoom and pinch zoom are orthogonal to the pixel-to-dp conversion added
 * there, so this file keeps its fixture at the identity density (see [fixture]) and is otherwise unchanged.
 */
